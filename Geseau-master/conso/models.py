...
class Entreprise(models.Model):
    ...
    nom_societe = models.CharField(default="Nom de la société", max_length=100, null=True, blank=True, verbose_name="Nom de l'entreprise ou de la société")
    ...
    localite = models.CharField(default="Localisation de la société", max_length=100, null=True, blank=True, verbose_name="Localisation")
...
class Section(models.Model):
    ...
    class Meta:
        # Utilisation de UniqueConstraint pour garantir l'unicité
        constraints = [
            UniqueConstraint(fields=['entreprise', 'nom_section'], name='unique_entreprise_section')
        ]
...
class Client(models.Model):
    ...
    prenom_client = models.CharField(default="Votre prénom", max_length=100, null=True, blank=True, verbose_name="Votre prénom")
    entreprise = models.ForeignKey(Entreprise, null=True, blank=True, on_delete=models.CASCADE)
    activite = models.CharField(default="Quel travail exercez-vous?", max_length=100, null=True, blank=True, verbose_name="Le travail que vous faites")
...
class Dispositif(models.Model):
    ...
    numero_serie = models.CharField(max_length=100, null=True, blank=True, verbose_name="Numéro de série")
    ...
    class Meta:
        # Utilisation de UniqueConstraint pour garantir l'unicité
        constraints = [
            UniqueConstraint(fields=['section', 'nom_lieu'], name='unique_section_nom_lieu')
        ]
